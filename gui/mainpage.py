...
#    Jan 25, 2019 11:35:06 AM EST  platform: Windows NT
...
class TopLevel:
    def __init__(self, top=None):
        ...
        top.title("Device Information")
        top.configure(background="#ffffff")
        top.configure(highlightbackground="#d9d9d9")
        top.configure(highlightcolor="black")

        self.DeviceInfo = tk.Frame(top)
        self.DeviceInfo.place(relx=0.0, rely=0.0, relheight=1.0, relwidth=1.0)
        self.DeviceInfo.configure(relief='groove')
        self.DeviceInfo.configure(borderwidth="2")
        self.DeviceInfo.configure(relief='groove')
        self.DeviceInfo.configure(background="#d9d9d9")
        self.DeviceInfo.configure(highlightbackground="#d9d9d9")
        self.DeviceInfo.configure(highlightcolor="black")
        self.DeviceInfo.configure(width=125)

        self.IIO_Context = tk.Label(self.DeviceInfo)
        self.IIO_Context.place(relx=0.33, rely=0.0, height=54, width=211)
        ...
        self.DeviceFrame = tk.LabelFrame(self.DeviceInfo)
        self.DeviceFrame.place(relx=0.0, rely=0.111, relheight=0.2, relwidth=1.0)
        ...
        self.AttrFrame = tk.LabelFrame(self.DeviceInfo)
        ...
        self.DebugAttrsFrame = tk.LabelFrame(self.DeviceInfo)
        self.DebugAttrsFrame.place(relx=0.0, rely=0.759, relheight=0.2
                , relwidth=1.0)
        ...
        self.ChannelFrame = tk.LabelFrame(self.DeviceInfo)
        self.ChannelFrame.place(relx=0.0, rely=0.333, relheight=0.2
                , relwidth=1.0)
        ...
        self.Switch = tk.Button(top)
        self.Switch.place(relx=0.073, rely=0.037, height=24, width=46)
        self.Switch.configure(activebackground="#d9d9d9")
        self.Switch.configure(activeforeground="#000000")
        self.Switch.configure(background="#d9d9d9")
        self.Switch.configure(disabledforeground="#a3a3a3")
        self.Switch.configure(foreground="#000000")
        self.Switch.configure(highlightbackground="#d9d9d9")
        self.Switch.configure(highlightcolor="black")
        self.Switch.configure(pady="0")
        self.Switch.configure(text='''Open''')
