...
def animate(i):
    ...
    if rxData is not None:
        ...
        if PlutoController.rxPlotList[PlutoController.rxPlotIndex] == 'Time':
        ...
        elif PlutoController.rxPlotList[
                PlutoController.rxPlotIndex] == 'Frequency':
            w, h = sig.freqz(
                rxData, fs=PlutoController.getSdr().sampling_frequency)
            ...
            ax1.set_ylabel('Amplitude [dB]')
                ...
                PlutoController.rxPlotIndex] == 'Constellation (X vs Y)':
    ...
    if txData is not None:
        ...
        if PlutoController.txPlotList[PlutoController.txPlotIndex] == 'Time':
        ...
        elif PlutoController.txPlotList[
                PlutoController.txPlotIndex] == 'Frequency':
            w, h = sig.freqz(
                txData, fs=PlutoController.getSdr().sampling_frequency)
            ...
            ax2.set_ylabel('Amplitude [dB]')
                ...
                PlutoController.txPlotIndex] == 'Constellation (X vs Y)':
