...
#  Apr 15, 2019 11:56:46 PM EDT  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top42 {base} {
    ...
    checkbutton $top.che43 \
        ...
        -font TkDefaultFont -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black -justify left \
        -text Transmit -variable transmit 
    vTcl:DefineAlias "$top.che43" "Checkbutton1_1" vTcl:WidgetProc "Throughput_TL" 1
    checkbutton $top.che44 \
        -activebackground {#d9d9d9} -activeforeground {#000000} \
        -background {#ffffff} -disabledforeground {#a3a3a3} \
        -font TkDefaultFont -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black -justify left \
        -text {Correct Frequency} -variable correct_frequency 
    vTcl:DefineAlias "$top.che44" "CorrectFrequency" vTcl:WidgetProc "Throughput_TL" 1
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.lab43 \
    ...
    place $top.lab46 \
        ...
        -anchor nw -bordermode ignore 
    place $top.lab47 \
        -in $top -x 310 -y 270 -width 144 -relwidth 0 -height 31 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.lab48 \
    ...
    place $top.lab50 \
        ...
        -bordermode ignore 
    place $top.lab51 \
        -in $top -x 310 -y 310 -width 144 -relwidth 0 -height 31 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.lab55 \
    ...
    place $top.lab58 \
        ...
        -bordermode ignore 
    place $top.lab59 \
        -in $top -x 450 -y 270 -width 124 -height 31 -anchor nw \
        -bordermode ignore 
    place $top.lab61 \
        -in $top -x 450 -y 310 -width 124 -height 31 -anchor nw \
        -bordermode ignore 
    place $top.lab62 \
        -in $top -x 320 -y 190 -width 124 -height 31 -anchor nw \
        -bordermode ignore 
    place $top.lab63 \
        -in $top -x 320 -y 230 -width 124 -height 31 -anchor nw \
        -bordermode ignore 
    place $top.lab64 \
        -in $top -x 450 -y 190 -width 124 -height 31 -anchor nw \
        -bordermode ignore 
    place $top.lab65 \
        -in $top -x 450 -y 230 -width 124 -height 31 -anchor nw \
        -bordermode ignore 
    place $top.lab44 \
    ...
    place $top.ent55 \
        ...
        -anchor nw -bordermode ignore 
    place $top.ent56 \
        -in $top -x 440 -y 60 -width 114 -relwidth 0 -height 30 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.lab42 \
    ...
    place $top.ent54 \
        ...
        -bordermode ignore 
    place $top.che42 \
        -in $top -x 340 -y 100 -width 201 -relwidth 0 -height 25 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.che43 \
        -in $top -x 340 -y 130 -width 81 -relwidth 0 -height 25 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.che44 \
        -in $top -x 340 -y 150 -width 131 -relwidth 0 -height 25 -relheight 0 \
        -anchor nw -bordermode ignore 
